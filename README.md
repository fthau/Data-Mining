...
Evaluated model reliability using K-Fold Cross-Validation and hold-out splits, quantifying performance with MAE, MSE, RMSE, and R² metrics to analyze model fit and error.  
